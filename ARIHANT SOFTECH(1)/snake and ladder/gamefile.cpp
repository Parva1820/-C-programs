...
parva=parva+randomnumber1;
    cout << endl;
     cout << "Parva rolled: " << randomnumber1 << endl;
        file << "Parva rolled: " << randomnumber1 << endl;
...
if(parva<=101){
    ...
    cout << endl;
        ...
        for(int i=0; i<10; i++){
          ...
          cout << "Parva is at position: " << parva << endl;
        file << "Parva is at position: " << parva << endl;
...
player=player+randomnumber2;
    cout << endl;
      cout << "Player rolled: " << randomnumber2 << endl;
        file << "Player rolled: " << randomnumber2 << endl;
...
cout << "Player is at position: " << player << endl;
        file << "Player is at position: " << player << endl;
